export default function App() {
  return (
    <>
      <img src={`/styling/wave/blackWave.png`} className={` w-full h-full `} />
      <section
        data-section-id="1"
        data-share=""
      ...
      >
        <div className="container mx-auto px-4 ">
          <div className="max-w-xl mx-auto text-center">
            ...
            <div className="flex flex-col largeMobile:flex-row items-center justify-center mb-6">
              <a
                className="inline-block text-Green hover:text-indigo-500 mb-6 largeMobile:mb-0 largeMobile:mr-6"
                href="https://shuffle.dev/#"
              >
                <svg
                  width="24"
              ...
              <a
                className="inline-block text-Green hover:text-indigo-500"
                href="https://shuffle.dev/#"
              >
                <svg
                  width="24"
