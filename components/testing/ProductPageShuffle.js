        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap -mx-4 justify-content">
            <div className="w-full lg:w-1/4 px-4 mb-12 lg:mb-0">
              <div
                className={`${styles.hideInSmallDeviceShowInLarge} flex flex-wrap -mx-4 -mb-8`}
              >
                <div className="w-full sm:w-1/2 lg:w-full px-4 mb-8">
                  <h4
                  ...
                  <ul>
                    <li className="mb-4">
                      <a
                        className="inline-block font-medium text-black hover:text-indigo-500"
                        href="https://shuffle.dev/#"
                ...
                <div className="w-full sm:w-1/2 lg:w-full px-4 mb-8">
                  ...
                  <div className="flex flex-wrap -mb-2">
                    <button className="inline-block w-6 h-6 bg-emerald-500 mb-2 mr-4 rounded-full border border-white hover:border-black"></button>
                    <button
                      className={`inline-block w-6 h-6 ${styles.greenBg} mb-2 mr-4 rounded-full border border-white hover:border-black`}
                    ></button>
                    <button className="inline-block w-6 h-6 bg-indigo-500 mb-2 mr-4 rounded-full border border-white hover:border-black"></button>
                    <button className="inline-block w-6 h-6 bg-orange-500 mb-2 mr-4 rounded-full border border-white hover:border-black"></button>
                    <button className="inline-block w-6 h-6 bg-red-500 mb-2 mr-4 rounded-full border border-white hover:border-black"></button>
                    <button className="inline-block w-6 h-6 bg-blue-500 rounded-full border border-white hover:border-black"></button>
                  </div>
                </div>
                <div className="w-full sm:w-1/2 lg:w-full px-4 mb-8">
                  <h4
                ...
                <div className="w-full sm:w-1/2 lg:w-full px-4 mb-8">
                  ...
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <span className="font-medium" id="numberRange"></span>
                  </div>
                </div>
                <div className="w-full sm:w-1/2 lg:w-full px-4 mb-8">
                  <h4
                  ...
                  <div className="flex flex-wrap -mx-1 -mb-1">
                    <div className="p-1">
                      <button
                        className="flex w-10 h-9 items-center justify-around text-sm font-bold border-2 border-black hover:bg-green-500 rounded-md"
                ...
                <div className="w-full sm:w-1/2 lg:w-full px-4 mb-8">
                  ...
                  <input
                    className="h-12 w-full px-4 py-2 mb-4 text-sm focus:outline-indigo placeholder-black font-bold border-2 border-black rounded-md"
                    type="text"
                    placeholder="City"
                    data-config-id="auto-input-14-2"
                  />
                  <div className="group relative h-12 border-2 border-black rounded-md overflow-hidden">
                    <select
                      className="w-full h-full px-4 text-sm font-bold appearance-none outline-none"
                      name=""
                      id=""
                      ...
                      <div>
                        ...
                        <ul className="font-bold md:w-[87%] w-full list-disc list-inside text-black mb-4">
                          ...
                          <li data-config-id="auto-txt-33-2">
                            {" "}
                            For className 12 , JEE , NEET aspirants
                          </li>
                        ...
                        <div className="flex flex-nowrap sm:flex-nowrap items-center -mx-2 -mb-4">
                          <div className="w-full sm:w-auto px-2 mb-4">
                            <a
                              className="group relative inline-block h-12 w-full sm:w-52 -mb-2 bg-black rounded-md"
                              href="https://shuffle.dev/#"
                            >
